<template>
  <section id="descubre-como" class="py-16 bg-gradient-to-b from-white to-gray-50">
...
.step-card:hover .step-icon {
  ...
  box-shadow: 0 10px 20px rgba(121, 53, 141, 0.3);
}
...
.step-number {
  ...
  font-weight: 700;
  font-size: 0.875rem;
  box-shadow: 0 4px 6px rgba(121, 53, 141, 0.3);
  z-index: 3;
}
