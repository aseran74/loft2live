-- Añadir columna street_view_embed para iframe de Google Street View
-- El usuario pega el código iframe desde Google Maps y guardamos la URL src

alter table public.proyectos
  add column if not exists street_view_embed text;

comment on column public.proyectos.street_view_embed is 'URL src del iframe de Google Street View (se puede pegar el iframe completo o solo la URL)';

-- Actualizar RPCs para devolver street_view_embed
