-- Añadir columna consulta_vinculante_urbanistica a proyectos (si no existe)
-- e incluirla en las RPC públicas

alter table public.proyectos
  add column if not exists consulta_vinculante_urbanistica boolean not null default false;

comment on column public.proyectos.consulta_vinculante_urbanistica is 'Indica si el proyecto tiene consulta vinculante urbanística';

-- Actualizar RPCs para devolver la nueva columna
