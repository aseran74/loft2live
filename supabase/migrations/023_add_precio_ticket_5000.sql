-- Dividir proyectos en tickets de 5000€ para invertir
alter table public.proyectos
  add column if not exists precio_ticket numeric default 5000;

comment on column public.proyectos.precio_ticket is 'Importe por ticket de inversión (ej: 5000€). Los inversores compran tickets de este importe.';

-- Actualizar RPCs para devolver precio_ticket
